...
f = open("RESULTS/" + str(evid)+"_output.txt","a")
...
print('')
print("-------------- ", evid, " --------------")
print("ORDATE START END: ",evid,ordate, start_time, end_time )
...
#                output_line = (f"{str(evid):<10s} {composite_name:<25s}    EQ: {mean_eq:5.3f}  {count_eq:<3d}  "
...
#                    f"ProbDist: {mean_pd:5.3f}    Pred: {max_class}  {sorted_means[0]:5.3f}  {pred_count:<3d}")
                output_line = (f"{str(evid):<10s} {composite_name:<25s}    EQ: {mean_eq:5.3f}  {count_eq:<3d}  EX: {mean_ex:5.3f}  {count_ex:<3d}  SU: {mean_su:5.3f}  {count_su:<3d}    ProbDist: {mean_pd:5.3f}    Pred: {max_class}  {sorted_means[0]:5.3f}  {pred_count:<3d}  Analyst: {analyst_class}")
                #print(output_line)
                f.write(output_line + "\n")
...
for k in range(0,len(prob_stns)):
    ...
    sorted_pvals = sorted(pvals, reverse=True)
    pdistance = sorted_pvals[0] - sorted_pvals[1]
    print(f"PROBS: {evid} {'SeismicCNN1d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} ")
    f.write(f"PROBS: {evid} {'SeismicCNN1d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} \n")
...
for k in range(0,len(prob_stns)):
    ...
    sorted_pvals = sorted(pvals, reverse=True)
    pdistance = sorted_pvals[0] - sorted_pvals[1]
    print(f"PROBS: {evid} {'SeismicCNN2d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} ")
    f.write(f"PROBS: {evid} {'SeismicCNN2d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} \n")
...
for k in range(0,len(prob_stns)):
    ...
    sorted_pvals = sorted(pvals, reverse=True)
    pdistance = sorted_pvals[0] - sorted_pvals[1]
    print(f"PROBS: {evid} {'QuakeXnet1d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} ")
    f.write(f"PROBS: {evid} {'QuakeXnet1d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f} { big_station_ids[k]} \n")
...
for k in range(0,len(prob_stns)):
    ...
    sorted_pvals = sorted(pvals, reverse=True)
    pdistance = sorted_pvals[0] - sorted_pvals[1]
    print(f"PROBS: {evid} {'QuakeXnet2d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} ")
    f.write(f"PROBS: {evid} {'QuakeXnet2d':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} \n")
...
for k in range(0,len(prob_stns)):
    ...
    sorted_pvals = sorted(pvals, reverse=True)
    pdistance = sorted_pvals[0] - sorted_pvals[1]
    print(f"PROBS: {evid} {'ML40sec':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} ")
    f.write(f"PROBS: {evid} {'ML40sec':<15s} {k:2d} {eqprob:.7f} {exprob:.7f} {noprob:.7f} {suprob:.7f} {snrs[k]:7.2f}  {big_station_ids[k]} \n")
