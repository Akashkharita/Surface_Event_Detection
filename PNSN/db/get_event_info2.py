...
def get_event_info(evid):
    ...
    if etype != 'st':
        if prefmag is not None:
            cursor.execute('select o.evid,  o.orid, o.datetime, o.lat, o.lon, o.depth, o.distance, o.wrms, o.algorithm, o.rflag, n.magnitude, n.magtype, n.uncertainty, n.nsta, n.magalgo from origin o inner join event e on o.orid = e.prefor inner join netmag n on n.magid = e.prefmag where e.evid = (%s) order by o.datetime desc', (  evid, ) )
            for record in cursor:
                evid = record[0]
                orid = record[1]
